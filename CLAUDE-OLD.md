...
## Key Principles
### ROI-First Thinking
- Always calculate ROI for every task
- Focus on time saved, error reduction, reusability, and user impact
### Fail Fast Protocol
- If an approach isn't working after 2 attempts, stop and reassess
- Try a different pattern or ask for clarification
- Document why it failed to improve future attempts
### Pattern Library Growth
- Every solution should be extractable as a pattern
- Include ROI calculation, test coverage, and documentation in CLAUDE.md
### Batch Operations
- Claude performs better with batch operations
- Read multiple files at once, run parallel bash commands, group similar changes, and batch test
### Knowledge Compounding
- Each task should build on previous learnings
- Update methodology, improve patterns, and increase automation
### Meta-Learning Loop
- After every session, reflect on:
